...
define('API_KEY', '8372553738:AAEYX1PYsvU8k1nvT0grTEFuSA9IGauc9mw');
...
else if ($text == "⬇️ Panelni Yopish" and in_array($cid,$admin)){
...
$mes=sendVideo("@$kino",$video,"🎬 <b>Kino kodi:</b> <code>$code</code>\n\n<b> ✅ <b>Aynan shu videoni kinosi to'liq xolda @$bot ga joylandi !</b>

⚠️ Filmni yuklab olish uchun Botimizga kiring va kodni kiriting ! 
 \n 📎 Bot manzili: @$bot</b>",null)->result->message_id;
...
$mes=sendPhoto("@$kino",$photo,"🎬 <b>Kino kodi:</b> <code>$code</code>\n\n<b>✅ Ushbu videoni kinosini botga joyladik, botga kino kodini yuboring va kinoni yuklab oling. \n\n📎 Bot manzili:</b> @$bot,",null)->result->message_id;
